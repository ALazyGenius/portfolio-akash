...
import { faCameraRetro, faRoute, faMountain, faGuitar, faGamepad, faHamburger } from "../../../../node_modules/@fortawesome/free-solid-svg-icons";
        ...
        <div className="row interests-subcontainer">
          ...
          <div className="interestes-table">
            ...
            <div className="fa-ul margin-btm">
              ...
              <li>
                <span className="nav-item-icon text-primary">
                  “<i>We travel not to escape life but for life not to escape us.</i>”
                </span>
              </li>
              <li>
                <span className="nav-item-icon text-primary">
                  “<i>Of all the paths you take in life, make sure a few of them are dirt.</i>”
                </span>
              </li>
            </div>
          </div>
